...
Console.WriteLine("  - customers (id, first_name, last_name, email, created_at)");
Console.WriteLine("  - orders (id, customer_id, total, status, order_date)");
Console.WriteLine();
Console.WriteLine("Indexes created:");
Console.WriteLine("  - idx_customers_email");
Console.WriteLine("  - idx_orders_customer_id");
Console.WriteLine("  - idx_orders_status");
